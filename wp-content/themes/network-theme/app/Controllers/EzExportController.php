            ...
            'data' => [
                'products' => array_map(function($product) {
                    ...
                    return [
                        ...
                        'tags' => $tags,
                        'seo' => [
                            'meta_title' => get_post_meta($product_id, '_network_meta_title', true),
                            'meta_description' => get_post_meta($product_id, '_network_meta_description', true),
                            'focus_keywords' => get_post_meta($product_id, '_network_focus_keywords', true),
                            'canonical_url' => $this->decodeUrlForExport(get_post_meta($product_id, '_network_canonical_url', true)),
                            'redirect_to' => $this->decodeUrlForExport(get_post_meta($product_id, '_network_redirect_to', true)),
                            'redirect_type' => get_post_meta($product_id, '_network_redirect_type', true),
                            'image_alt_tag' => get_post_meta($product_id, '_network_image_alt', true),
                            'source_url' => get_post_meta($product_id, '_network_source_url', true),
                            'display_rank' => get_post_meta($product_id, '_network_display_rank', true),
                        ],
