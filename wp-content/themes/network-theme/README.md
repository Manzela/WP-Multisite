# Network Theme - WordPress Multisite E-commerce Blueprint
...
1. **Clone the repository**
   ```bash
   git clone https://github.com/your-username/network-theme.git
   cd network-theme
   ```
...
#### Import Products
**Endpoint**: `POST /wp-json/network/v1/import`
  ...
  "products": [
    {
      ...
      "seo": {
        "source_url": "https://example.com/sample-localized-slug",
...
#### Export Products
**Endpoint**: `GET /wp-json/network/v1/export`
...
- **Issues**: [GitHub Issues](https://github.com/your-username/network-theme/issues)
...
$source_url = urldecode(get_post_meta($product_id, '_network_source_url', true));
```
