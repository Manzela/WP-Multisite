...
class PermalinkServiceProvider extends ServiceProvider
{
    ...
    public function boot()
    {
        ...
        // Use MU-Plugin helper 'shopper_is_subsite_path' if available
    ...
    public function resolve_cross_site_request()
    {
        ...
        $lang = get_query_var('lang', function_exists('shopper_derive_lang_from_locale') ? shopper_derive_lang_from_locale() : 'en'); // Dynamic default from locale
    ...
    {
        // Delegate to global single source of truth (defined in shopper-network-core.php mu-plugin)
        if (function_exists('shopper_get_store_language_map')) {
            return shopper_get_store_language_map();
        }
    ...
    public function get_url_segments()
    {
        ...
        if (function_exists('shopper_derive_lang_from_locale')) {
            $lang = shopper_derive_lang_from_locale();
        } else {
            $locale = get_locale();
        ...
        return [
            ...
            'mega_slug' => get_option('store_mega_slug', function_exists('shopper_get_clean_mega_slug')
                ? shopper_get_clean_mega_slug($store_slug)
